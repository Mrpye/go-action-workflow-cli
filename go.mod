module github.com/Mrpye/hauler

go 1.18

replace github.com/Mrpye/go-action-workflow => C:\projects\go\go-workflow
...
require (
	github.com/Mrpye/go-action-workflow v0.3.0
...
require (
	...
	github.com/Mrpye/go-data-chain v0.2.0 // indirect
	github.com/Mrpye/go_k8_helm v0.2.1 // indirect
