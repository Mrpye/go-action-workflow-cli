## hauler manifest action create k8_delete_pod
...
```
hauler manifest action create k8_delete_pod [[job_key add to job][] global action] [flags]
```

### Options

```
  -n, --cfg-name string          Name of the Pod
