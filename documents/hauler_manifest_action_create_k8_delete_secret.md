## hauler manifest action create k8_delete_secret
...
```
hauler manifest action create k8_delete_secret [[job_key add to job][] global action] [flags]
```

### Options

```
  -n, --cfg-name string          Name of the secret
