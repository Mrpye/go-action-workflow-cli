## hauler manifest action create k8_delete_deployment
...
```
hauler manifest action create k8_delete_deployment [[job_key add to job][] global action] [flags]
```

### Options

```
  -n, --cfg-name string          Name of the Deployment
