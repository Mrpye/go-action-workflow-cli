## hauler manifest action create k8_delete_pv
...
```
hauler manifest action create k8_delete_pv [[job_key add to job][] global action] [flags]
```

### Options

```
  -n, --cfg-name string          Name of the PV
